...
public class Fourth3 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityfourth3);
        setTitle("Reverse Crunch");
        ex14=findViewById(R.id.ex14);
        textView23=findViewById(R.id.textView23);
        Typeface myfont = Typeface.createFromAsset(getAssets(), "Magnificent.ttf");
        textView23.setTypeface(myfont);
        AnimationDrawable myanimation=(AnimationDrawable)ex14.getDrawable();
        myanimation.start();
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==R.id.myshare)
        {
            ...
            String shareBody = textView23.getText().toString();
