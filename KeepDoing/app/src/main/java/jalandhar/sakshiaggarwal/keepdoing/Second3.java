...
public class Second3 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activitysecond3);
        setTitle("Fiffer Scissors");
        ex12=findViewById(R.id.ex12);
        textView19=findViewById(R.id.textView19);
        Typeface myfont = Typeface.createFromAsset(getAssets(), "Magnificent.ttf");
        textView19.setTypeface(myfont);
        AnimationDrawable myanimation=(AnimationDrawable)ex12.getDrawable();
        myanimation.start();
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==R.id.myshare)
        {
            ...
            String shareBody = textView19.getText().toString();
